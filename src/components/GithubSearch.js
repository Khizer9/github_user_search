...
const GithubSearch = () => {
    ...
    const [search, setSearch] = useState('khizer9');
    ...
    return (
        <div className='main'>
            ...
            <h2 style={{margin: '20px'}}>Github</h2>
            </div>
            <input className='searchInput' type="text" name="search" id="search" placeholder='Enter github username...' onChange={handleChange}/>
            ...
            <div>
                ...
                <h1>Public Repositories: {user.public_repos}</h1>
            </div>
        </div>
    );
};
